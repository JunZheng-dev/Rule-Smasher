...
public class Player1 extends Creature {
    ...
    public Player1(Handler handler, float x, float y) {
        ...
        bounds.y = 0;
        bounds.width = (int) (67 * Creature.DEFAULT_CREATURE_HEIGHT / 100);
        bounds.height = Creature.DEFAULT_CREATURE_HEIGHT;
        facingRight = true;
        
        // Setting animations
        animLeft = new Animation(200, Assets.p1Left);
        animRight = new Animation(200, Assets.p1Right);
    }
    ...
    private void getInput() {
        ...
        if (handler.getKeyManager().w && !jumped) {
            speedY = -jumpSpeed;
        }
